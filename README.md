...
面向美国市场、Shopify 和 eBay 美国站的跨境女装目录治理 Web 工作台。

它把供应商资料整理为规范的 Product/SKU，完成分类、美国合规、平台草稿和治理审核，最后导出可交付的商品资料包。第一版只生成导入文件，不自动发布商品。

## 能力

- 导入 CSV、Excel、JSON、PDF、Markdown、文本和图片资料。
- 建立可追溯的商品与 SKU 事实，保留来源和证据。
- 检查美国服装法规、Shopify 和 eBay 美国站要求。
- 生成 Shopify 表格和 eBay 数据草稿。
